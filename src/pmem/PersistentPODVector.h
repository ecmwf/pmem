...
public:
    ...
    AtomicConstructor1(const size_t& x1) : AtomicConstructor1Base<PersistentPODVectorData<T>,size_t>(x1) {}
...
public:
    ...
    AtomicConstructor2(const PersistentPODVectorData<T>& x1, const size_t& x2) :
