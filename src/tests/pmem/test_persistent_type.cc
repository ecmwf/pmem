...
public: // members
    ...
    PersistentPtr<PersistentType<CustomType> > data_[root_elems];
};
...
PersistentPtr<PersistentType<RootType> > global_root;

struct SuitePoolFixture {

    SuitePoolFixture() : autoPool_(RootType::Constructor()) {
        Log::info() << "Opening global pool" << std::endl;
        global_root = autoPool_.pool_.getRoot<PersistentType<RootType> >();
    }
    ~SuitePoolFixture() {
        global_root.nullify();
    }
...
BOOST_AUTO_TEST_CASE( test_pmem_persistent_type_nullification )
{
    PersistentPtr<PersistentType<CustomType> > ptr;
...
BOOST_AUTO_TEST_CASE( test_pmem_persistent_type_equality )
{
    PersistentPtr<PersistentType<CustomType> > ptr1;
    PersistentPtr<PersistentType<CustomType> > ptr2;
    PersistentPtr<PersistentType<CustomType> > ptr3;
    PersistentPtr<PersistentType<CustomType> > ptr4;
    PersistentPtr<PersistentType<CustomType> > ptr5;
...
BOOST_AUTO_TEST_CASE( test_pmem_persistent_type_allocate_needs_pmem )
{
    PersistentPtr<PersistentType<CustomType> > ptr;
...
BOOST_AUTO_TEST_CASE( test_pmem_persistent_type_direct_allocate )
{
    ...
    PersistentPtr<PersistentType<CustomType> > p1 = global_root->data_[0];
    ...
    PersistentPtr<PersistentType<CustomType> > p2 = global_root->data_[0];
...
BOOST_AUTO_TEST_CASE( test_pemem_persistent_ptr_cross_pool )
{
    ...
    PMEMobjpool * raw_pool2 = ::pmemobj_pool_by_ptr(pool2.getRoot<PersistentType<RootType> >().get());
    ...
    PMEMobjpool * raw_pool2a = ::pmemobj_pool_by_ptr(pool2a.getRoot<PersistentType<RootType> >().get());
    ...
    PersistentPtr<PersistentType<CustomType> > p2 = global_root->data_[1];
...
BOOST_AUTO_TEST_CASE( test_pmem_persistent_type_typeid )
{
    ...
    PersistentPtr<PersistentType<OtherType> > pother = *reinterpret_cast<PersistentPtr<PersistentType<OtherType> >*>(&p);
